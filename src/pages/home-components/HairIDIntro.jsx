...
const HairIDIntro = () => {
  return (
    <div className='rounded-lg shadow-md overflow-hidden nf bg-eggshell mx-10 sm:mx-20 md:mx-60 py-10'>
      <div className='flex items-center justify-center'>
        <div className='grid grid-cols-1'>
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
            <h1 className="text-2xl md:text-2xl lg:text-4xl font-bold max-w-[25rem] col-span-1 m-4 order-2 lg:order-1">
